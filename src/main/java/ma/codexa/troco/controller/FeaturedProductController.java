...
import ma.codexa.troco.service.FeaturedProductService;
...
public class FeaturedProductController {
    ...
    public ResponseEntity<ApiResponse<List<FeaturedProductDTO>>> getAllFeaturedProducts(
        ...
        log.debug("Récupération des produits sélectionnés includeInactive={}", includeInactive);
        List<FeaturedProductDTO> featuredProducts = includeInactive
                ? featuredProductService.getAllFeaturedProductsForAdmin()
                : featuredProductService.getAllFeaturedProducts();
