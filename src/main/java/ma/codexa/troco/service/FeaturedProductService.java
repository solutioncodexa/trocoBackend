...
import ma.codexa.troco.dto.request.CreateFeaturedProductRequest;
import ma.codexa.troco.dto.request.ReorderFeaturedProductsRequest;
import ma.codexa.troco.dto.request.ToggleFeaturedProductRequest;
import ma.codexa.troco.dto.request.UpdateFeaturedProductRequest;
import ma.codexa.troco.entity.FeaturedProduct;
import ma.codexa.troco.entity.Product;
import ma.codexa.troco.mapper.FeaturedProductMapper;
import ma.codexa.troco.repository.FeaturedProductRepository;
...
public class FeaturedProductService {
    ...
    public List<FeaturedProductDTO> getAllFeaturedProducts() {
        log.debug("Récupération des produits sélectionnés actifs");
    ...
    @Transactional(readOnly = true)
    public List<FeaturedProductDTO> getAllFeaturedProductsForAdmin() {
        return featuredProductRepository.findAll().stream()
                .sorted((a, b) -> {
                    int bySection = a.getSection().getValue().compareTo(b.getSection().getValue());
